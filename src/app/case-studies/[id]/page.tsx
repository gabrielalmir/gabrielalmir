    ...
    <div className="min-h-screen bg-background text-vesper-orange font-mono selection:bg-vesper-orange selection:text-black">
      ...
      <main className="container mx-auto px-4 py-12 max-w-6xl">
        ...
        >
          <div className="terminal-window border border-vesper-orange/20 p-8">
            <div className="flex items-center justify-between mb-6">
              ...
              {study.featured && (
                <div className="px-3 py-1 bg-vesper-orange/10 border border-vesper-orange/20 rounded text-sm text-vesper-orange/80">
                  Projeto Destacado
                </div>
              )}
            </div>
            ...
            <p className="text-xl text-vesper-orange/60 font-medium mb-6">
              {study.subtitle}
            </p>

            <p className="text-lg text-vesper-orange/80 mb-8 leading-relaxed">
              {study.description}
            </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-8">
              <div className="text-center">
                ...
                <div className="text-sm text-vesper-orange/60">Duração</div>
                <div className="font-bold text-vesper-orange">{study.duration}</div>
              </div>
              <div className="text-center">
                <Users className="h-6 w-6 text-vesper-orange mx-auto mb-2" />
                <div className="text-sm text-vesper-orange/60">Equipe</div>
                <div className="font-bold text-vesper-orange">{study.teamSize}</div>
              </div>
              <div className="text-center">
                <Code2 className="h-6 w-6 text-vesper-orange mx-auto mb-2" />
                <div className="text-sm text-vesper-orange/60">Tecnologias</div>
                <div className="font-bold text-vesper-orange">{study.technologies.length}+</div>
              </div>
              <div className="text-center">
                <TrendingUp className="h-6 w-6 text-vesper-orange mx-auto mb-2" />
                <div className="text-sm text-vesper-orange/60">Melhorias</div>
                <div className="font-bold text-vesper-orange">{study.results.length}</div>
              </div>
            </div>
        ...
        <motion.section
          ...
          className="mb-12"
        >
          <div className="terminal-window border border-vesper-orange/20 p-6 mb-6">
            <div className="flex items-center gap-2 mb-4">
              <BarChart className="h-5 w-5 text-vesper-orange" />
              <span className="terminal-prompt">&gt; metrics.display()</span>
            </div>
            <h2 className="text-2xl font-bold text-vesper-orange mb-2">Resultados Mensuráveis</h2>
            <p className="text-vesper-orange/80">Impacto quantificável do projeto</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {study.metrics.map((metric, index) => (
              <motion.div
                ...
                className="terminal-window border border-vesper-orange/20 p-6 text-center hover:border-vesper-orange/40 transition-all duration-300"
              >
                <div className="text-3xl font-bold text-vesper-orange mb-2">
                  {metric.value}
                </div>
                <div className="text-sm text-vesper-orange/80 mb-2">
                  {metric.label}
                </div>
                <div className="text-xs text-green-400 font-medium mb-3">
                  {metric.improvement}
                </div>
                <div className="text-xs text-vesper-orange/60 leading-relaxed">
                  {metric.description}
                </div>
              </motion.div>
            ))}
        ...
        >
          <div className="grid gap-8 lg:grid-cols-2">
            ...
            <div className="terminal-window border border-vesper-orange/20 p-6">
              ...
              <h3 className="text-xl font-bold text-vesper-orange mb-4">O Desafio</h3>
              <p className="text-vesper-orange/80 leading-relaxed mb-6">
                {study.challenge}
              </p>

              <div className="space-y-3">
                <h4 className="font-bold text-vesper-orange/90">Principais Obstáculos:</h4>
                {study.challenges.map((challenge, index) => (
                  <div key={index} className="flex items-start gap-2">
                    <span className="text-red-400 mt-1">▸</span>
                    <span className="text-vesper-orange/80 text-sm">{challenge}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="terminal-window border border-vesper-orange/20 p-6">
              ...
              <h3 className="text-xl font-bold text-vesper-orange mb-4">A Solução</h3>
              <p className="text-vesper-orange/80 leading-relaxed mb-6">
                {study.solution}
              </p>

              <div className="space-y-3">
                <h4 className="font-bold text-vesper-orange/90">Principais Aprendizados:</h4>
                {study.learnings.map((learning, index) => (
                  <div key={index} className="flex items-start gap-2">
                    <span className="text-green-400 mt-1">▸</span>
                    <span className="text-vesper-orange/80 text-sm">{learning}</span>
                  </div>
                ))}
              </div>
            </div>
        ...
        >
          <div className="terminal-window border border-vesper-orange/20 p-6">
            ...
            <h2 className="text-2xl font-bold text-vesper-orange mb-6">Resultados Alcançados</h2>
            ...
            <div className="grid gap-4 md:grid-cols-2">
              {study.results.map((result, index) => (
                <motion.div
                  ...
                  animate={{ opacity: 1, x: 0 }}
                  transition={{ duration: 0.5, delay: index * 0.1 }}
                  className="flex items-start gap-3 p-4 bg-vesper-orange/5 border border-vesper-orange/20 rounded"
                >
                  <CheckCircle className="h-5 w-5 text-green-400 mt-0.5 flex-shrink-0" />
                  <span className="text-vesper-orange/90">{result}</span>
                </motion.div>
              ))}
            </div>
          </div>
