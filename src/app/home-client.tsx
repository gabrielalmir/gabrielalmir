...
const GitHubProjects = dynamic(() => import("@/components/github-projects"), {
  ssr: false,
  loading: () => (
...
const CoreStack = dynamic(() => import("@/components/core-stack"), {
  ssr: true,
  loading: () => <div className="h-96 w-full animate-pulse bg-vesper-orange/5 rounded-xl"></div>
});
