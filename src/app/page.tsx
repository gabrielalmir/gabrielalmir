        ...
        <section className="py-20 md:py-10 grid md:grid-cols-2 gap-10 items-center">
          <div className="space-y-6 animate-fade-in">
            ...
            <div className="terminal-window border border-terminal-green/20 p-4 space-y-4">
              <TypingEffect
                text="Desenvolvedor Backend especializado em Node.js e Java (Spring Boot)"
                className="text-lg"
              />
              <p className="text-terminal-green/80 leading-relaxed">
                Construo soluções escaláveis e de alto desempenho utilizando <strong className="text-terminal-green">Node.js</strong> e <strong className="text-terminal-green">Java (Spring Boot)</strong>.
