export const resumeData = {
      ...
      projects: [
        {
          name: 'TechFinance',
          description:
            'Aplicação para gestão de produtos, vendas, clientes e relatórios financeiros, com insights e assistente virtual (Dinho Bot). Backend em Node.js/TypeScript (Bun.js), API de previsão em Python, app mobile em React Native e versão web em Next.js 15.',
        },
        {
          name: 'Tethys',
          description:
            'Proposta técnica para identificação, tratamento e alerta de alagamentos na cidade de Itapira. Arquitetura baseada em microserviços, com banco SQL (Postgres) e NoSQL (MongoDB), além de simulações de captura de dados com Node-RED.',
        },
        {
          name: 'Portal de Editais',
          description:
            'Portal para centralizar o fluxo de contratação de docentes via edital interno, do lançamento à revisão de formulários. Ênfase em transparência, acompanhamento público e organização do fluxo de trabalho.',
        },
      ],
    },
    {
  ...
  certifications: [
    ...
    {
      name: 'Qualificação Profissional Desenvolvedor Back-end | Centro Paula Souza (Fatec)',
      year: '2025',
    },
    {
      name: 'AWS Academy Graduate – Machine Learning for Natural Language Processing | AWS',
      year: '2025',
    },
