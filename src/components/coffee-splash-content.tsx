...
type SplashAction =
  { type: 'appendLog'; value: string } | { type: 'setStep'; value: SplashStep } | { type: 'hide' };
  ...
  useEffect(() => {
    ...
    const processLogs = () => {
      if (currentIndex >= bootSequence.length) {
        ...
        timeoutIds.push(
          window.setTimeout(() => dispatch({ type: 'setStep', value: 'ready' }), 800),
        );
                  ...
                  <div className="flex flex-col md:flex-row gap-8 items-start">
                    ...
                    <div className="flex-1 space-y-6 w-full">
                      ...
                      <div className="pt-4 flex justify-between items-center">
                        ...
                        <span className="text-xs text-vesper-orange animate-pulse">
                          LOADING ASSETS...
                        </span>
                      </div>
                    </div>
