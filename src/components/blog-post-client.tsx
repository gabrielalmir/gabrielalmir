...
const MarkdownH1 = ({ children, node: _node, ...props }: MarkdownHeadingProps) => (
  <h1
    className="text-3xl sm:text-4xl md:text-5xl font-bold text-vesper-orange mt-10 sm:mt-12 md:mt-14 mb-5 sm:mb-6 md:mb-7 border-b border-vesper-orange/20 pb-3 sm:pb-4 leading-[1.2] break-words tracking-tight"
    {...props}
  >
...
const MarkdownH2 = ({ children, node: _node, ...props }: MarkdownHeadingProps) => (
  <h2
    className="text-2xl sm:text-3xl md:text-4xl font-bold text-vesper-orange mt-8 sm:mt-10 md:mt-12 mb-4 sm:mb-5 md:mb-6 leading-[1.25] break-words tracking-tight"
    {...props}
  >
    {children ?? <span className="sr-only">Heading</span>}
  </h2>
...
const MarkdownH3 = ({ children, node: _node, ...props }: MarkdownHeadingProps) => (
  <h3
    className="text-xl sm:text-2xl md:text-3xl font-bold text-vesper-orange mt-7 sm:mt-8 md:mt-10 mb-3 sm:mb-4 md:mb-5 leading-[1.3] break-words tracking-tight"
    {...props}
  >
    {children ?? <span className="sr-only">Heading</span>}
  </h3>
...
const MarkdownH4 = ({ children, node: _node, ...props }: MarkdownHeadingProps) => (
  <h4
    className="text-lg sm:text-xl md:text-2xl font-bold text-vesper-orange mt-6 sm:mt-7 md:mt-8 mb-3 sm:mb-4 leading-[1.35] break-words tracking-tight"
    {...props}
  >
    {children ?? <span className="sr-only">Heading</span>}
  </h4>
...
const MarkdownP = (props: React.HTMLAttributes<HTMLParagraphElement>) => (
  <p
    className="text-foreground/90 leading-[1.85] mb-5 sm:mb-6 md:mb-7 text-base sm:text-lg md:text-xl break-words font-light"
    {...props}
  />
);
...
const MarkdownUl = (props: React.HTMLAttributes<HTMLUListElement>) => (
  <ul
    className="list-disc pl-5 sm:pl-7 md:pl-8 my-5 sm:my-6 md:my-7 text-foreground/90 space-y-3 sm:space-y-4"
    {...props}
  />
);
...
const MarkdownOl = (props: React.HTMLAttributes<HTMLOListElement>) => (
  <ol
    className="list-decimal list-inside space-y-3 sm:space-y-4 my-5 sm:my-6 md:my-7 text-foreground/90 pl-2 sm:pl-3"
    {...props}
  />
);
...
const MarkdownLi = ({ children, ...props }: React.HTMLAttributes<HTMLLIElement>) => (
  <li
    className="leading-[1.85] text-base sm:text-lg md:text-xl break-words mb-2 font-light"
    {...props}
  >
    {children}
  </li>
...
const MarkdownCode = ({
  ...
  if (isInline) {
    return (
      <code
        className="bg-vesper-orange/15 text-vesper-orange px-2 sm:px-2.5 py-1 rounded text-sm sm:text-base font-mono break-words border border-vesper-orange/20"
        {...props}
      >
        {children}
      </code>
...
const MarkdownPre = ({ children, ...props }: React.HTMLAttributes<HTMLPreElement>) => (
  <pre
    className="bg-zinc-900/80 border border-vesper-orange/30 rounded-lg p-4 sm:p-6 md:p-8 my-6 sm:my-8 md:my-10 overflow-x-auto shadow-lg"
    {...props}
  >
    <code className="text-vesper-cyan/90 text-sm sm:text-base font-mono block leading-relaxed">
      {children}
    </code>
  </pre>
);
...
const MarkdownBlockquote = (props: React.HTMLAttributes<HTMLQuoteElement>) => (
  <blockquote
    className="border-l-4 border-vesper-orange/50 pl-5 sm:pl-7 md:pl-8 py-3 sm:py-4 my-6 sm:my-8 md:my-10 italic text-foreground/85 bg-vesper-orange/5 rounded-r-lg text-base sm:text-lg md:text-xl break-words leading-[1.8] font-light"
    {...props}
  />
);
...
const MarkdownTable = (props: React.HTMLAttributes<HTMLTableElement>) => (
  <div className="overflow-x-auto my-6 sm:my-8 md:my-10 -mx-4 sm:mx-0">
    <table
      className="w-full min-w-full border border-vesper-orange/20 text-base sm:text-lg md:text-xl"
      {...props}
    />
  </div>
);
...
const MarkdownTh = (props: React.HTMLAttributes<HTMLTableCellElement>) => (
  <th
    className="text-left p-3 sm:p-4 md:p-5 text-vesper-orange font-bold text-sm sm:text-base md:text-lg break-words"
    {...props}
  />
);
...
const MarkdownTd = (props: React.HTMLAttributes<HTMLTableCellElement>) => (
  <td
    className="p-3 sm:p-4 md:p-5 text-foreground/90 text-sm sm:text-base md:text-lg break-words"
    {...props}
  />
);
...
export default function BlogPostClient({ post }: Readonly<BlogPostClientProps>) {
  const categoryInfo = categories[post.category] || categories.technical;
  ...
  return (
    <LazyMotion features={domAnimation}>
      <div className="min-h-screen bg-background text-vesper-orange font-mono selection:bg-vesper-orange selection:text-black overflow-x-hidden">
        ...
        <main
          id="main"
          className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 py-8 sm:py-12 lg:py-16 max-w-5xl w-full"
        >
          <m.div
          ...
          >
            <div className="terminal-window border border-vesper-orange/20 p-5 sm:p-6 md:p-8 lg:p-10">
              <div className="flex items-center gap-2 mb-5 sm:mb-6 md:mb-7">
                <CategoryIcon
                  className={`h-4 w-4 sm:h-5 sm:w-5 flex-shrink-0 ${categoryInfo.color}`}
                />
              ...
              <div className="flex flex-wrap items-center gap-3 sm:gap-6 mb-4 sm:mb-6 text-xs sm:text-sm text-vesper-orange/60">
                <div className="flex items-center gap-1.5 sm:gap-2">
                  ...
                  <span className="break-words">
                    {new Date(post.date).toLocaleDateString('pt-BR')} (UTC-3)
                  </span>
                </div>
                <div className="flex items-center gap-1.5 sm:gap-2">
            ...
            <div className="terminal-window border border-vesper-orange/20 p-4 sm:p-6">
              ...
              <div className="flex flex-col sm:flex-row items-center sm:items-start gap-3 sm:gap-4">
                ...
                <div className="text-center sm:text-left">
                  <h3 className="text-base sm:text-lg font-bold text-vesper-orange break-words">
                    {post.author || 'Gabriel Almir'}
                  </h3>
                  <p className="text-sm sm:text-base text-vesper-orange/80 break-words">
