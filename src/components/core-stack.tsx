    ...
    return (
        <div className="space-y-8">
            <div className="flex flex-wrap items-center gap-3">
                ...
                <h3 className="text-xs uppercase tracking-[0.2em] font-mono text-vesper-orange/80 font-semibold">Core Stack</h3>
                <Badge variant="outline" className="border-vesper-orange/20 text-vesper-orange/70 text-[10px] uppercase tracking-wider font-mono">
                ...
                {coreStackItems.map(({ icon, label, level }) => (
                    ...
                    >
                        ...
                        <div className="flex flex-col items-center gap-3.5">
                            <LazyDevIcon icon={icon} size={42} className="text-vesper-cyan group-hover:scale-110 group-hover:text-vesper-cyan/100 transition-all duration-300" />
                            <div className="text-center">
                                <div className="font-semibold text-foreground/90 text-sm">{label}</div>
                                <div className="text-[10px] text-vesper-orange/60 mt-1 font-mono uppercase tracking-wider">{level}</div>
                            </div>
                        </div>
                    </div>
                ))}
