...
const caseStudies: CaseStudy[] = [
  {
    ...
    description:
      'Implementação de solução automatizada em Python para integrar dados entre sistemas ERP, otimizando o carregamento e fluxo de atendimento através de cron jobs.',
    challenge:
      'Sistema existente apresentava lentidão significativa na sincronização de dados entre ERPs, causando atrasos no atendimento e acesso a informações críticas de bulas.',
    solution:
      'Desenvolvimento de scripts Python para automação via cron jobs, implementando lógica de sincronização eficiente e sistema de cache para dados frequentemente acessados.',
    results: [
          ...
          >
            <div className="terminal-window border border-vesper-orange/20 p-8">
              ...
              <p className="text-xl text-vesper-orange/80 leading-relaxed mb-6">
                Projetos reais que demonstram expertise técnica, resolução de problemas complexos e
              ...
              {featuredStudies.map((study, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <p className="text-vesper-orange/60 font-medium mb-4">{study.subtitle}</p>
                    ...
                    <div className="grid grid-cols-3 gap-4 mb-6">
                      {study.metrics.map((metric) => (
                        <div key={metric.label} className="text-center">
                          <div className="text-lg font-bold text-vesper-orange">{metric.value}</div>
                          <div className="text-xs text-vesper-orange/60">{metric.label}</div>
              ...
              <div className="flex flex-wrap gap-4 items-center">
                <div className="flex flex-wrap gap-2">
                  <Button
                    ...
                    className={
                      selectedCategory === 'all' ? 'terminal-button' : 'terminal-button-outline'
                    }
                  >
                    Todos
                  </Button>
                  {Object.entries(categories).map(([key, { label, icon: Icon, color }]) => (
                    <Button
                      ...
                      className={
                        selectedCategory === key ? 'terminal-button' : 'terminal-button-outline'
                      }
                    >
          ...
          >
            ...
            {filteredStudies.length === 0 && (
              ...
              >
                ...
                <p className="text-vesper-orange/60">Tente ajustar os filtros selecionados.</p>
                <div className="mt-4 text-vesper-orange/40 text-sm">
                  <span className="terminal-prompt">$</span> find ./case-studies -type f | grep
                  &quot;{selectedCategory}&quot; | wc -l
                  <br />
