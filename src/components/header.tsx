...
export const Header = () => {
    return (
        <header className="fixed top-0 z-50 w-full border-b border-vesper-orange/10 bg-background/95 backdrop-blur-md">
            <nav className="container mx-auto px-4 sm:px-6 lg:px-8 py-3">
                <div className="flex justify-between items-center">
                    <a href="/" className="hover:opacity-80 transition-opacity" aria-label='logo gabrielalmir'>
                        <ModernLogo />
                    </a>
